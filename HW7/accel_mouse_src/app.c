...
void APP_ProcessSwitchPress(void)
{
    ...
    if(BSP_SWITCH_STATE_PRESSED == (BSP_SwitchStateGet(13)))//APP_USB_SWITCH_1)))
    {
...
void APP_Initialize ( void )
{
    ...
    acc_setup();
    acc_write_register(CTRL2,0x00); //ctrl2 = 0x21
}
...
void APP_Tasks ( void )
{
    ...
    int y = accels[0]*3/16000;
    int x = -1*accels[1]*3/16000;
